...
// PipelineRunApplyConfiguration represents an declarative configuration of the PipelineRun type for use
// with apply.
...
// PipelineRun constructs an declarative configuration of the PipelineRun type for use with
// apply.
